  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || "Failed to create deliverable")
      }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Add New Deliverable</h1>
          <p className="text-gray-600">Create a new plan deliverable for the project</p>
        </div>
      </div>
